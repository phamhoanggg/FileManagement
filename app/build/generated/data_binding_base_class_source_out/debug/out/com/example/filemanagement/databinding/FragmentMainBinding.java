...
public final class FragmentMainBinding implements ViewBinding {
  ...
  private FragmentMainBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMainBinding((LinearLayout) rootView, recyclerView);
    }
